...
task01_normData = load(fullfile(bucket.pathToSubject,'task02/processed/normAnalysis.mat'));
...
title ('Error norm of FT vs Skin','FontSize',15);
axis tight;
ax = gca;
ax.FontSize = 15;
L = get(gca,'YTick');
...
title ('Error norm of contact forces','FontSize',15);
axis tight;
ax = gca;
ax.FontSize = 15;
L = get(gca,'YTick');
...
title ('Error norm of joint dynamic quantities','FontSize',15);
axis tight;
ax = gca;
ax.FontSize = 15;
L = get(gca,'YTick');
...
% end
[norm_fixedVSfloating.MEANaccLinError_norm_task01 ;
norm_fixedVSfloating.STDaccLinError_norm_task01 ]
[norm_fixedVSfloating.MEANaccAngError_norm_task01 ;
norm_fixedVSfloating.STDaccAngError_norm_task01]


[norm_fixedVSfloating.MEANfextError_norm_task01; 
norm_fixedVSfloating.STDfextError_norm_task01 ]
[norm_fixedVSfloating.MEANmextError_norm_task01; 
norm_fixedVSfloating.STDmextError_norm_task01]

[norm_fixedVSfloating.MEANddsError_norm_task01 ;
norm_fixedVSfloating.STDddsError_norm_task01 ]
[norm_fixedVSfloating.MEANtauError_norm_task01 ;
norm_fixedVSfloating.STDtauError_norm_task01 ]

[norm_fixedVSfloating.MEANaccLinError_norm_task01 ,norm_fixedVSfloating.MEANaccAngError_norm_task01 , norm_fixedVSfloating.MEANfextError_norm_task01 , norm_fixedVSfloating.MEANmextError_norm_task01, norm_fixedVSfloating.MEANddsError_norm_task01 ,norm_fixedVSfloating.MEANtauError_norm_task01 ; 
norm_fixedVSfloating.STDaccLinError_norm_task01,norm_fixedVSfloating.STDaccAngError_norm_task01,norm_fixedVSfloating.STDfextError_norm_task01 ,norm_fixedVSfloating.STDmextError_norm_task01,norm_fixedVSfloating.STDddsError_norm_task01 ,norm_fixedVSfloating.STDtauError_norm_task01 ]