...
baseVelocity=[baseVel(blockIdx).baseLinVelocity;baseVel(blockIdx).baseAngVelocity];
        ...
        [tau_iDyn(blockIdx).tau_kinDyn,tau_iDyn(blockIdx).baseWrench] = iDynTreeID_kinDyn_floating(human_kinDynComp, ...
            currentBase, ...
            bucket.orientation(blockIdx).baseOrientation, ...
            bucket.basePosition(blockIdx).basePos_wrtG, ...
            baseVelocity,...%IDcomparisonParams.baseVel(blockIdx).baseVel_wrtG, ...
